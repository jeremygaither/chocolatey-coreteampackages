...
$version = '149.0.7820.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1623698/mini_installer.exe'
  checksum      = 'E61E4710EC5D224378DC09AEE2F2CC86D92EC5FA2174EF31BD4E3BA923ED15E6'
  checksumType  = 'sha256'
