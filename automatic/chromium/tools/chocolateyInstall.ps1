...
$version = '149.0.7821.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1624141/mini_installer.exe'
  checksum      = '33F893084D3D796B04D76A59D20F2F165C4F69A9791CBF1D0A4C16E61CA5E295'
  checksumType  = 'sha256'
