...
$version = '149.0.7822.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1624245/mini_installer.exe'
  checksum      = 'F888B10FE03C5FD4DACAE767AB988665382F07CAFF7ED74F1A68DAFA2990FFBE'
  checksumType  = 'sha256'
