...
$version = '149.0.7824.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1624389/mini_installer.exe'
  checksum      = '4B0C664ACB4EB931A8FAEFC3AEEAAEFBD816B6F3077EA09BD823BB180F479552'
  checksumType  = 'sha256'
