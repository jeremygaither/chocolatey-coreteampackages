...
$version = '149.0.7823.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1624304/mini_installer.exe'
  checksum      = '89B9F412BD671D1B1E9DE9CFA3CF8C849CD1F0CD22EC7D8458AA17C6897CC68F'
  checksumType  = 'sha256'
