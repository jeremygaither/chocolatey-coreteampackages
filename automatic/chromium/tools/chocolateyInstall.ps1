...
$version = '149.0.7827.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1624704/mini_installer.exe'
  checksum      = 'BBB0C0AC24BA800CE33897D8D19AA8FCE1EC4E7B41C71DFA3224333BB1F9F0F3'
  checksumType  = 'sha256'
